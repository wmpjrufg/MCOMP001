...
<table>
    <tbody>
        ...
        <tr>
            <td><img src="assets/images/fig150-11.jpeg" class="centered-image" style="margin-bottom: 20px; width: 70%;"></td>
        </tr>
        <tr>
            <td><b>Velocidade da água = \(v = 2\) m/seg (adotado)</b>, se não houver medição no local.</td>
        </tr>
    </tbody>
</table>
...
<img src="assets/images/fig150-12.jpeg" class="centered-image" style="margin-bottom: 20px; width: 70%;">
