...
<table>
    <tbody>
        <tr>
            <td>\(
                k \cdot 2 \cdot x_1 - 3 \cdot x_2)=k \cdot (-8) 
                \)</td>
                <td class="formula">Exemplo k = 8,5 não alteraria a linha 1 por exemplo.
                </td>
            </tr>
        </tr>
    </tbody>
...
<table>
    <tbody>
        <tr>
            <td>\(
                L_1 ⟵ -\frac{1}{2} \cdot L_1 e L_2 ⟵ 3 \cdot L_1 + L_2
                \)</td>
            </tr>
            <tr>
                <td>\(
                     \begin{bmatrix} 2 & -3 & -8 \\ 3 & 4 & 5 \end{bmatrix} ⟶ \begin{bmatrix} -1 & 1.5 & 4 \\ 3 & 4 & 5 \end{bmatrix} ⟶ \begin{bmatrix} -1 & 1.5 & 4 \\ 0 & 8.5 & 17
                    \)</td>
                <td class="formula">Li ⟵ k ⋅ Li</td>
            </tr>
        </tr>
...
<p align="left" id="fig123-0"><b>Figura 2.</b> Solução gráfica do conjunto de duas equações após as operações elementares.</p>
