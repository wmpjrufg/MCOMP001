...
<table>
    <tbody>
        ...
        <tr>
            <td>
                \(\begin{bmatrix} 3.0 & -0.10 & -0.20 & 7.85 \\ 0.1 & 7.0 & -0.30 & -19.3 \\ 0.3 & -2.0 & 10.0 & 71.4 \end{bmatrix} \rightarrow \begin{bmatrix} 3.0 & -0.10 & -0.20 & 7.85 \\ 0.0 & 7.003 & -0.2933 & -19.5617 \\ 0.3 & -2.0 & 10.0 & 71.4 \end{bmatrix}\)
            </td>
