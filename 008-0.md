...
Este tutorial ensina a criar gráficos com a biblioteca `matplotlib.pyplot` do Python. Vamos abordar:

- Como montar um gráfico
- Como editar eixos, cores, tamanhos e legendas
- Exemplos: scatter plot, line plot e histograma
...
<p align="left" id="fig122-0"><b>Figura .</b> Exemplo de Line Plot</p>
...
<p align="left" id="fig122-0"><b>Figura .</b> Exemplo de Histogram</p>
