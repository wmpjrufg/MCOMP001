...
<table>
    <tbody>
        ...
        <tr>
            <td>\(\Delta \sigma_w = \sigma_{sw, max} - \sigma_{sw, min} = \frac{|V_{g + q}|_{max} - 0.50 \cdot V_c}{0.90 \cdot d \cdot \frac{A_{sw}}{s}} \cdot \frac{|V_{g + q}|_{max} - |V_{g + q}|_{min}}{|V_{g + q}|_{max}}
        </tr>
    </tbody>
</table>
