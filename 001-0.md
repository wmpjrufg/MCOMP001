...
biblioteca = {
                'livro1': {'autores': 'Lopes A - Garcia G', 'editora': 'GENLTC', 'pag': 488, 'ISBN': 8535210199}
             }
```
<p align = "justify">
...
{: .note }
> A referência `lista[-1]` é o acesso a última posição da lista. A visualização regressiva também é valida exemplo: `[-2] [-3]`. 
