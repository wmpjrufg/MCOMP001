...
<head>
    ...
    <title>Tabela de Operações com Equações</title>
    <style>
        /* Estilo padrão para todas as tabelas (borda visível) */
        table {
            width: 100%;
        ...
        /* Estilos para a tabela com bordas invisíveis */
        .tabela-invisivel, .tabela-invisivel th, .tabela-invisivel td {
            border: none;
        }
        .tabela-invisivel .formula {
            text-align: right;
        }
    </style>
</head>
