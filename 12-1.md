...
<table style="width: 100%;">
  ...
  <tr>
    ...
    <td style="text-align: right;">
      <!-- Você pode adicionar outro número de identificação aqui, se necessário -->
    </td>
  </tr>
</table>
